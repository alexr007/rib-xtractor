...
public class LogEntry {
    ...
    private final int offsetTimestamp = 0;//len=4
    private final int offsetLat = 7; //len=4
    private final int offsetLon = 11; //len=4
    private final int offsetAlt = 17; //len=2
    private final int offsetSpeed = 15; //len=2
    ...
    public LogEntry(byte[] log_entry) {
